...
public class KeyActionAlarmEventSettingService  extends CachedAlarmEventSettingService<DefaultAlarmEventTarget,ApplicationEventSetting> {
	...
	protected int getEventTargetType() {
		return EventConstants.EVENT_TARGET_TYPE_KEYACTION;
	}
