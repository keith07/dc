...
@Entity
@Table(name="NL_U_KEY_ACTION_EVENTS")
public class KeyActionEvent extends AbstractEventEntity {
	 ...
	 * Key Action ID
	 */
	@Column(name="key_action_id", nullable=false)
	...
	public int getKeyActionId() {
		return keyActionId;
	}
	public void setKeyActionId(int keyActionId) {
